...
func (r Tar) MarshalJSON() ([]byte, error) {
	var concrete struct {
...
func (r *Tar) UnmarshalJSON(bs []byte) error {
	var concrete struct {
		Container *dagger.Container
	}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Tar":
		...
		case "Create":
			...
			var compress bool
			if inputArgs["compress"] != nil {
				err = json.Unmarshal([]byte(inputArgs["compress"]), &compress)
				if err != nil {
					panic(fmt.Errorf("%s: %w", "failed to unmarshal input arg compress", err))
				}
			}
			return (*Tar).Create(&parent, ctx, directory, compress)
		case "":
			var parent Tar
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
