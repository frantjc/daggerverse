...
func (r *Client) Wolfi() *Wolfi { // wolfi (https://github.com/dagger/dagger/tree/d8811256e5e901e6760f7011431080fedd61fc47/modules/wolfi/main.go#L10)
...
type Wolfi struct { // wolfi (https://github.com/dagger/dagger/tree/d8811256e5e901e6760f7011431080fedd61fc47/modules/wolfi/main.go#L10)
	query *querybuilder.Selection
...
type WolfiContainerOpts struct {
	...
	//
	Packages []string // wolfi (https://github.com/dagger/dagger/tree/d8811256e5e901e6760f7011431080fedd61fc47/modules/wolfi/main.go#L16)
	//
	// Hardware architecture to target
	//
	Arch string // wolfi (https://github.com/dagger/dagger/tree/d8811256e5e901e6760f7011431080fedd61fc47/modules/wolfi/main.go#L19)
	//
	// Extra repositories to add to the package resolver
	//
	ExtraRepositories []string // wolfi (https://github.com/dagger/dagger/tree/d8811256e5e901e6760f7011431080fedd61fc47/modules/wolfi/main.go#L22)
	//
	// Extra keys needed to authenticate the extra repositories
	//
	ExtraKeyUrls []string // wolfi (https://github.com/dagger/dagger/tree/d8811256e5e901e6760f7011431080fedd61fc47/modules/wolfi/main.go#L25)
	//
	// Overlay images to merge on top of the base.
	// See https://twitter.com/ibuildthecloud/status/1721306361999597884
	//
	Overlays []*Container // wolfi (https://github.com/dagger/dagger/tree/d8811256e5e901e6760f7011431080fedd61fc47/modules/wolfi/main.go#L29)
}

// Build a Wolfi Linux container
func (r *Wolfi) Container(opts ...WolfiContainerOpts) *Container { // wolfi (https://github.com/dagger/dagger/tree/d8811256e5e901e6760f7011431080fedd61fc47/modules/wolfi/main.go#L13)
	q := r.query.Select("container")
	for i := len(opts) - 1; i >= 0; i-- {
