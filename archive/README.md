...
```sh
dagger api call -m github.com/frantjc/daggerverse/archive tar --directory ./dist --gzip export --path dist.tgz
```

Unpack a tarball back to a directory:

```sh
dagger api call -m github.com/frantjc/daggerverse/archive untar --file dist.tgz export --path ./dist
```
